...
// 
//This file is an altered version of the RooStat tutorial "StandardHypoTestInvDemo.C".  
//It takes the signal/background models from files created in "Model_Workspace_Config.C".
//I haven't gotten it to give very sensible results yet
...
bool useVectorStore = false;              // convert data to use new roofit data store 
...
double maxPOI = 10;                      // max value used of POI (in case of auto scan) 
...
void 
StandardHypoTestInvDemo(const char * infile = "model_workspace.root",
                        const char * wsName = "w",
                        const char * modelSBName = "model",
