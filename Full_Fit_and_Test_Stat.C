...
double Full_Fit_and_Test_Stat(double n_0_fraction_input = 0., double num_generated_input = 1000)
{
	
	RooMsgService::instance().setGlobalKillBelow(RooFit::WARNING); //silence fitting messages
	
	//Load Data
	TFile *F_0NuBB = new TFile("~/DBeta-master/output/DBeta_Debug_0NuBB.root","READ");
	TFile *F_2NuBB = new TFile("~/DBeta-master/output/DBeta_Debug_2NuBB.root","READ");
...
//	TFile *F_2NuBB = new TFile("/u/nobackup/lwinslow/elagin/data/db_out/Te130_2vbb_1e6.root","READ"); //Contains more data
	...
	double num_generated = num_generated_input; //Data size generated from PDFs to be fit by PDFs
	double n_0_fraction = n_0_fraction_input;
	double n_0_generated = num_generated*n_0_fraction;
//	double n_2_generated = num_generated-n_0_generated;
	double n_2_generated = num_generated;
